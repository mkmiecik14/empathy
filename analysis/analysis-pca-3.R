...
# UPDATE FROM analysis-pca-2.R: uses knee_CPM and drops shoulder CPM
...
script <- "analysis-pca-3" # script for file prefix when saving
...
dd_flip_bs <- 
  ...
  select(-shoulder_CPM) # removes shoulder_CPM
