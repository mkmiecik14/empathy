...
for i = 1:length(subjs)
    ...
    EEG = pop_loadbv(strcat(eeg_data_path, "/baseline-visit/"), this_subj.name, [], []);
    ...
    EEG = pop_rmbase( EEG, [],[]);
    [ALLEEG, EEG, CURRENTSET] = pop_newset(ALLEEG, EEG, 1,'setname',this_subj.id,'overwrite','on','gui','off');  % 'setname','ss359',
